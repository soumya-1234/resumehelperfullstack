                                ...
                                <div class="card-body p-5">
                                    ...
                                    <form>
                                        ...
                                        <div class="d-flex justify-content-center" v-if="bool2">
                                            <button type="button"
                                            class="btn btn-warning btn-block btn-lg gradient-custom-4 text-body" @click.prevent="jdetails">Update</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
    ...
    methods:{
        ...
        checkdata(){
            for(var i=0;i<this.data.length;i++){
                if(this.data[i].rid==this.ssid){
                    this.formdata.jtitle=this.data[i].jtitle;
                    this.formdata.skills=this.data[i].skills;
                    this.formdata.jdesc=this.data[i].jdesc;
                    this.objid=this.data[i]._id;
                }
            }
        },
        jdetails(){
            ...
            if(this.formdata.jtitle==""){
                ...
                axios.put("https://resumehelpbackend.onrender.com/recruiters/jobupdate/"+this.objid,this.formdata)
